...
public class AdaptedPreparedStatement extends AdaptedStatement implements PreparedStatement
{
    protected PreparedStatement comando=null;

    public AdaptedPreparedStatement (String drv,
                                 String strCon,
                                 String usr,
                                 String senha)
    ...
    public ResultSet executeQuery () throws SQLException
    {
        ...
        AdaptedResultSet retorno = new AdaptedResultSet (this.comando, resultado);
    ...
    public boolean equals (Object obj)
    {
        ...
        if (this.getClass()==obj.getClass())
        {
            ...
            AdaptedPreparedStatement mps = (AdaptedPreparedStatement)obj;
