...
*/
public class Especialidade implements Cloneable,Serializable{
  ...
  public int hashCode() {
    ...
    hash = 89 * hash + this.MAX_NOME;
    return hash;
  }

  // Compara essa especialidade médica com outra, em termos de atributos.
  @Override
