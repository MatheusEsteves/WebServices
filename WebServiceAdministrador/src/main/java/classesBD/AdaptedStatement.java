...
public class AdaptedStatement implements Statement
{
    ...
    protected ArrayList<AdaptedResultSet> resultados =
              new ArrayList<AdaptedResultSet> ();

    public AdaptedStatement (String drv,
                         String strCon,
                         String usr,
                         String senha)
    ...
    public boolean equals (Object obj)
    {
        ...
        if (this.getClass()==obj.getClass())
        {
            ...
            AdaptedStatement ms = (AdaptedStatement)obj;
