...
public class MedicoProntoSocorros{
   ...
   * @throws Exception 
   */
  public MedicoProntoSocorros(AdaptedPreparedStatement bd)throws Exception{
    if (bd == null)
  ...
  public void incluir(MedicoProntoSocorro medicoProntoSocorro)throws Exception{
    ...
    int idMedico        = medicoProntoSocorro.getIdMedico();
    int idProntoSocorro = medicoProntoSocorro.getIdProntoSocorro();
